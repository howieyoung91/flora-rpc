...
public class ClientConfigBuilder {
    ...
    public ClientConfigBuilder(ClientConfigurer configurer, ClientConfigProperties properties) {
    ...
    private DefaultSerializeService getSerializers() {
        if (configurer != null) {
    ...
    private String getDefaultSerializer() {
    ...
    private DefaultCompressorService getCompressorService() {
        if (configurer != null) {
    ...
    private String getDefaultCompressor() {
